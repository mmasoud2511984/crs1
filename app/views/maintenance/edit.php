...
/**
 * File: edit.php
 * Path: /app/views/backend/maintenance/edit.php
 * Purpose: صفحة تعديل سجل صيانة موجود
...
$old = Session::getFlash('old') ?? $maintenance;
?>

<!-- رأس الصفحة -->
<div class="page-header">
    <div class="page-title">
        <h1><?= trans('maintenance.edit_record') ?> #<?= $maintenance['id'] ?></h1>
        <p><?= trans('maintenance.edit_record_desc') ?></p>
    </div>
    <div class="page-actions">
        <a href="/admin/maintenance/view/<?= $maintenance['id'] ?>" class="btn btn-secondary">
...
<div class="form-container">
    <form method="POST" action="/admin/maintenance/update/<?= $maintenance['id'] ?>" enctype="multipart/form-data" id="maintenanceForm">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-grid">
                    ...
                    <!-- معلومات السيارة -->
                    <div id="carInfo" class="info-box col-span-2">
                        <div class="info-grid">
                            <div class="info-item">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="service_center" class="form-control" 
                               ...
                               value="<?= htmlspecialchars($old['service_center'] ?? '') ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <?php if (!empty($maintenance['receipt_path'])): ?>
                                ...
                                <div class="receipt-preview">
                                    ...
                                    ?>
                                        <img src="/<?= htmlspecialchars($maintenance['receipt_path']) ?>" 
                                             alt="Current Receipt" style="max-width: 200px; max-height: 150px;">
                                    <?php else: ?>
                                        <a href="/<?= htmlspecialchars($maintenance['receipt_path']) ?>" target="_blank">
                                            <?= trans('maintenance.current_receipt') ?>
                                        </a>
                                    <?php endif; ?>
                                </div>
                                <small class="form-text"><?= trans('maintenance.replace_receipt_hint') ?></small>
                            </div>
                        <?php endif; ?>
                    ...
                    <div class="form-group col-span-2">
                        ...
                        <textarea name="description" class="form-control" rows="4" 
                                  ...
                                  placeholder="<?= trans('maintenance.description_placeholder') ?>"><?= htmlspecialchars($old['description']) ?></textarea>
                    ...
                    <div class="form-group col-span-2">
                        ...
                        <textarea name="parts_replaced" class="form-control" rows="3" 
                                  maxlength="1000"
                                  placeholder="<?= trans('maintenance.parts_placeholder') ?>"><?= htmlspecialchars($old['parts_replaced'] ?? '') ?></textarea>
                    </div>
                    ...
                    <div class="form-group col-span-2">
                        ...
                        <textarea name="notes" class="form-control" rows="3" 
                                  maxlength="1000"
                                  placeholder="<?= trans('maintenance.notes_placeholder') ?>"><?= htmlspecialchars($old['notes'] ?? '') ?></textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-actions">
            <button type="submit" class="btn btn-primary btn-lg">
                <i class="icon-save"></i>
                <?= trans('maintenance.update_record') ?>
            </button>
            <a href="/admin/maintenance/view/<?= $maintenance['id'] ?>" class="btn btn-secondary btn-lg">
                <i class="icon-x"></i>
                <?= trans('common.cancel') ?>
            </a>
        </div>
...
// تفعيل اختيار السيارة عند تحميل الصفحة
